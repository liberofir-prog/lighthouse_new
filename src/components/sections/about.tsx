...
const education = [
  ...
  "לימודי ליווי רוחני (בסיסי ומתקדם), עם התמחות בליווי ילדים ובני משפחותיהם, מכללת רמב\u05F4ם-ידע",
  ...
  "סטאז\u05F3רית (שנה שלישית) בפסיכותרפיה במשחק מטעם אוניברסיטת בר־אילן (היחידה ללימודי תעודה) ובית הספר לפסיכותרפיה במשחק",
];
...
const experience: { text: string; url?: string }[] = [
  ...
  { text: "מרצה בכנסים ארציים ובינלאומיים, בקורסים שונים לצוותים רפואיים וסיעודיים בבתי חולים וכן לסטודנטים בהכשרות שונות" },
];
          ...
          <div className="text-center mb-10 md:mb-14">
            ...
            <FadeIn delay={0.15}>
              <p className="text-base md:text-lg text-primary/70 font-medium max-w-2xl mx-auto">
                מדריכת הורים, מלווה רוחנית ומתמחה בפסיכותרפיה (שנה שלישית) בגישת Play Therapy
              </p>
            </FadeIn>
          </div>
                ...
                <div className="bg-card/60 backdrop-blur-sm rounded-2xl p-6 md:p-7 border border-amber/12 shadow-warm">
                  ...
                  <div className="space-y-3 text-foreground/90 leading-[1.8] text-[0.95rem]">
                    ...
                    <p>
                      ...
                      דרך משחק, דמיון ויצירה - בייחוד כאשר קשה להם להסביר במילים
                      את מה שהם מרגישים ומותאם במיוחד לילדים בגילאי 2.5 עד 10.
                    </p>
                    <p>
