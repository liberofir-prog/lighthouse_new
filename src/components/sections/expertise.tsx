...
const areas = [
  {
    ...
    description:
      "ליווי רגשי ורוחני לילדים ולהוריהם המתמודדים עם מחלה כרונית או מחלה קשה. המרחב מאפשר עיבוד רגשות, התמודדות עם פחדים ואי-ודאות וחיזוק תחושת הביטחון והמשמעות בתוך המציאות המשתנה. העבודה כוללת גם הדרכת הורים וכלים לתמיכה בילד ובמשפחה לאורך הדרך.",
    examples:
  ...
  },
  {
    ...
    title: "אובדן ושכול",
    description:
      "ליווי ותמיכה מקצועית לילדים, להורים ולמשפחות המתמודדים עם אובדן. המרחב מאפשר לתת מקום לכאב, לעבד את חוויית האבל ולהתמודד עם השינויים שהאובדן מביא לחיים. בתהליך מותאם אישית נבנית בהדרגה אפשרות לחיבור למשמעות, לכוחות ולדרך קדימה.",
    examples:
  ...
  {
    icon: Brain,
    title: "קשיים רגשיים/התנהגותיים ומשברי חיים",
    description:
      "ליווי רגשי לילדים המתמודדים עם קשיים רגשיים או התנהגותיים, ועם משברי חיים משמעותיים. בתהליך מותאם ואמפתי ניתן מקום לרגשות, מחזקים כוחות התמודדות ומסייעים לילד ולמשפחה למצוא יציבות וכיוון מחדש.",
    examples:
      "גירושין, שינויים משמעותיים בחיי המשפחה, תקופות של מתח ואי-ודאות (כמו: מלחמה), התפרצויות זעם, עצב, פחדים, הסתגרות ועוד.",
